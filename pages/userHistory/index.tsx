...
import { Flex, Text, useTheme, TableContainer, Table, Thead, Tr, Th, Tbody, Td } from "@chakra-ui/react";
...
const THeadData = ["Eletroposto", "Carro", "Custo", "Data de Entrada", "Data de Saída"];
              ...
              <Table size="sm">
                <Thead>
                  {THeadData.map((name, index) => {
                    return (
                      <Th key={index} textAlign={name === "Custo" ? "center" : "left"}>
                        {name}
                      </Th>
                    );
                  })}
